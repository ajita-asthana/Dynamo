defmodule StalenessTest do
    ...
    defp sendPutRequest(proc_name,message,node_name) do
        ...
        # IO.puts("[#{proc_name}]PUT: At #{node_name} return [#{key},#{value},#{context}]")
        # t2 = Emulation.now()
        # t = t2 - t1
    ...
    test "Staleness Test =>  When R+W > N" do
        ...
        spawn(:r3, fn -> sendGetRequest(:r3,478,choose_random_node()) end)    #read
        spawn(:r4, fn -> sendGetRequest(:r4,478,choose_random_node()) end)    #read
        spawn(:r5, fn -> sendGetRequest(:r5,478,choose_random_node()) end)    #read
        spawn(:r6, fn -> sendGetRequest(:r6,478,choose_random_node()) end)    #read
        spawn(:r7, fn -> sendGetRequest(:r7,478,choose_random_node()) end)    #read
        spawn(:r8, fn -> sendGetRequest(:r8,478,choose_random_node()) end)    #read
        spawn(:r9, fn -> sendGetRequest(:r9,478,choose_random_node()) end)    #read
        spawn(:r10, fn -> sendGetRequest(:r10,478,choose_random_node()) end)    #read
        spawn(:r11, fn -> sendGetRequest(:r11,478,choose_random_node()) end)    #read
        spawn(:r12, fn -> sendGetRequest(:r12,478,choose_random_node()) end)    #read
